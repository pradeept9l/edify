	...
	var Field = acf.Field.extend({
		...
		initialize: function(){
			...
			if( this.get('uploader') === 'basic' ) {
				this.$el.closest('page-bookcourse.php').attr('enctype', 'multipart/form-data');
			}
		},
	...
	var Field = acf.Field.extend({
		...
		onClickAdd: function( e, $el ){
			...
			var step2 = function( html ){
				...
				// vars
				$form = popup.$('page-bookcourse.php');
				...
				// submit form
				popup.on('submit', 'page-bookcourse.php', step3);
			};
	...
	*/
	...
	acf.screen.refreshAvailableMetaBoxesPerLocation = function() {
		...
		acf.getPostboxes().map(function( postbox ){
			...
			var location = postbox.$el.closest('page-bookcourse.php').attr('class').replace('metabox-location-', '');
...
(function($, undefined){
	...
	*/
	...
	acf.validateForm = function( args ){
		return getValidator( args.page ).validate( args );
	};
	...
	acf.validation = new acf.Model({
		...
		*/
		onInvalid: function( e, $el ){
			...
			// vars
			var $form = $el.closest('page-bookcourse.php');
