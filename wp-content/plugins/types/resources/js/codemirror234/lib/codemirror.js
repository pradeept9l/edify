...
window.CodeMirror = (function() {
  ...
  CodeMirror.fromTextArea = function(textarea, options) {
    ...
    if (textarea.page) {
      on(textarea.page, "submit", save);
      // Deplorable hack to make the submit method do the right thing.
      if (!options.leaveSubmitMethodAlone) {
        var form = textarea.page, realSubmit = form.submit;
        try {
    ...
    cm.toTextArea = function() {
      ...
      if (textarea.page) {
        off(textarea.page, "submit", save);
        if (typeof textarea.page.submit == "function")
          textarea.page.submit = realSubmit;
      }
    };
    return cm;
  };
